...
// Halaman login — dibuka di new tab/popup dari iframe Blogger.
// Setelah login, kirim postMessage ke opener lalu tutup tab.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800/60 border border-purple-700 rounded-2xl p-8">
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-zinc-500 text-xs">atau masuk dengan email</span>
            <div className="flex-1 h-px bg-gray-700"/>
          </div>

          {/* Error */}
          {error && (
            <div className="bg-red-900/40 border border-red-600 rounded-lg px-4 py-2 mb-4 text-sm text-red-300">
              {error}
            </div>
          )}
          ...
          <p className="text-center text-sm text-zinc-500 mt-6">
            Belum punya akun?{' '}
            <a href="/auth/register" className="text-yellow-400 hover:text-yellow-300 font-semibold">
              Daftar di sini
            </a>
          </p>
        </div>
